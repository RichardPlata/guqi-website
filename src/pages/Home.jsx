      ...
      <main className="home-page">
          ...
          <div className="container hero-content">
            <div className="hero-copy">
              ...
              <div className="hero-actions">
                ...
                <Link to="/terapias" className="btn btn-secondary">
                  Explorar Terapias
                </Link>
              </div>
          ...
          <div className="container">
            ...
            <div className="approach-grid">
              <ApproachCard
                ...
                text="Fusionamos biomagnetismo y medicina oriental en un protocolo unificado."
              />
              <ApproachCard
                title="Protocolo Personalizado"
                text="Cada tratamiento inicia con una evaluación energética individual."
              />
              <ApproachCard
                title="Terapia Sin Fármacos"
                text="Métodos naturales enfocados en restaurar el equilibrio del cuerpo."
              />
              <ApproachCard
                title="Resultados Medibles"
                text="Seguimiento continuo para evaluar avances durante el proceso terapéutico."
              />
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="conditions-grid">
              <ConditionCard
                ...
                text="Recupera equilibrio emocional y energético."
              />
              <ConditionCard
                title="Dolor Muscular"
                text="Tratamientos para tensión, contracturas y molestias persistentes."
              />
              <ConditionCard
                title="Inflamación"
                text="Protocolos orientados a restaurar funciones corporales alteradas."
              />
              <ConditionCard
                title="Bienestar Estético"
                text="Terapias reductivas, reafirmantes y drenaje linfático."
              />
              <ConditionCard
                title="Equilibrio Energético"
                text="Restablece armonía entre cuerpo y mente."
              />
              <ConditionCard
                title="Recuperación Integral"
                text="Un abordaje holístico para mejorar calidad de vida."
              />
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="therapy-grid">
              <HomeTherapyCard
                img={podalImg}
                title="Masaje Podal"
                text="Relajación profunda y estímulo reflejo para reequilibrar energía y circulación."
              />
              <HomeTherapyCard
                img={neckImg}
                title="Masaje Tuina Cervical"
                text="Tratamiento focalizado para tensiones cervicales, rigidez y movilidad."
              />
              <HomeTherapyCard
                img={lymphaticImg}
                title="Drenaje Linfático Completo"
                text="Estimulación del sistema linfático para reducir retención y favorecer recuperación."
              />
              <HomeTherapyCard
                img={tuinaImg}
                title="Masaje Tuina Cuerpo Completo"
                text="Sesión integral para restaurar movilidad, balance energético y bienestar general."
              />
            </div>
          </div>
        </section>
          ...
          <div className="container process-content">
            ...
            <div className="process-steps">
              <ProcessStep
                ...
                text="Identificamos síntomas, hábitos y desequilibrios para orientar el tratamiento."
              />
              <ProcessStep
                number="02"
                title="Sesión Personalizada"
                text="Aplicamos técnicas integrativas según tus necesidades físicas y energéticas."
              />
              <ProcessStep
                number="03"
                title="Seguimiento"
                text="Revisamos avances y ajustamos el protocolo para mantener resultados."
              />
            </div>
          </div>
        </section>
        ...
        <section className="final-cta">
          ...
          <div className="container final-cta-content">
            ...
            <p>
              Da el primer paso hacia una experiencia terapéutica personalizada.
            </p>
...
function HomeTherapyCard({ img, title, text }) {
  return (
    <div className="therapy-card">
      ...
      <div className="therapy-info">
        ...
        <Link to="/terapias" className="therapy-link">
          Ver detalle
        </Link>
      </div>
    </div>
